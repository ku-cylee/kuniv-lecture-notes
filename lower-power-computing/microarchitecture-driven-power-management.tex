...
\figcmd{lower-power-computing/images/cache-structure.PNG}{.6}
\begin{itemize}
    \item Cache의 작동 방식
    \begin{enumerate}
...
\end{itemize}
\figcmd{lower-power-computing/images/memory-wall.PNG}{.5}
...
\end{itemize}
\figcmd{lower-power-computing/images/energy-flexibity-gap.PNG}{.4}
...
\end{itemize}
\figcmd{lower-power-computing/images/process-variation.PNG}{.4}
