...
\begin{itemize}
    ...
    \begin{figures}
        \fig{lower-power-computing/images/leakage-power-components.PNG}{.4}
    \end{figures}
...
\begin{figures}
    \fig{lower-power-computing/images/low-swing-buses.PNG}{.6}
\end{figures}
\begin{itemize}
...
\begin{figures}
    \fig{lower-power-computing/images/bus-segmentation.PNG}{.6}
\end{figures}
\begin{itemize}
...
\begin{figures}
    \fig{lower-power-computing/images/network-on-chip.PNG}{.4}
\end{figures}
\begin{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \begin{figures}
        \fig{lower-power-computing/images/banked-cache.PNG}{.4}
    \end{figures}
...
\begin{figures}
    \fig{lower-power-computing/images/cache-structure.PNG}{.6}
\end{figures}
\begin{itemize}
    \item Cache의 작동 방식
    \begin{enumerate}
...
\end{itemize}
\begin{figures}
    \fig{lower-power-computing/images/memory-wall.PNG}{.55}
\end{figures}
...
\end{itemize}
\begin{figures}
    \fig{lower-power-computing/images/energy-flexibity-gap.PNG}{.5}
\end{figures}
...
\end{itemize}
\begin{figures}
    \fig{lower-power-computing/images/process-variation.PNG}{.5}
\end{figures}
