...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Irritation function is difficult to handle in mathematical manner
    \end{itemize}
    ...
    \end{itemize}
    \begin{figures}
        \fig{intro-to-convex-optimization/images/log-barrier.PNG}{.4}
    \end{figures}
\end{itemize}
...
\begin{itemize}
    ...
    \item Lagrangian gradient holds
\end{itemize}
